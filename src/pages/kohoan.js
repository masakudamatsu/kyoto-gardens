 ...
 */}{' '}
            ...
            <Section>
              <P>
                ...
                (<Kanji>小堀遠州</Kanji>), an architect, garden designer, and
                tea ceremony master (as well as being a samurai lord, or{' '}
            ...
            <Section>
              ...
              <P>
                ...
                (called <ForeignPhrase as="i">nobedan</ForeignPhrase> in
              ...
              <P>
                ...
                <ForeignPhrase>soto-machiai</ForeignPhrase> (a roofed bench
                where the invited guests to a tea ceremony would take a rest
                until the host comes to greet them).
              </P>
              <Spacer.TextParagraphToText />
              <P>
                As pointed out by{' '}
            ...
            <Section>
              ...
              <P>
                ...
                <ForeignPhrase as="i">hiwada</ForeignPhrase> (the bark of
                Japanese cypress), used for the roofs of major shrines in Kyoto,
                and <ForeignPhrase as="i">kokera</ForeignPhrase>
            ...
            <Section>
              ...
              <P>
                ...
                <ForeignPhrase>Oumi hakkei</ForeignPhrase>{' '}
                <Kanji>近江八景</Kanji>
                ).
              </P>
              <Spacer.TextParagraphToText />
              <P>
                ...
                in <ForeignPhrase as="i">tataki</ForeignPhrase>, an earthen
              ...
              <P>
                ...
                reach this point and turn to the right, you’ll find the entrance
                to the teahouse, where a tea ceremony is going to take place.
              </P>
              <Spacer.TextParagraphToText />
              <P>
            ...
            <Section>
              ...
              <Spacer.TextParagraphToText />
              <P>
                <ForeignPhrase as="i">Tokonoma</ForeignPhrase> is an alcove with
                a tatami floor to display a hanging scroll (as shown in the
              ...
              <P>
                ...
                <Kanji>忘筌</Kanji>) — is also derived (see the end of the first
                line):
              </P>
              <Spacer.TextLineToBox />
              <FigureWithBorder>
              ...
              <P>
                ...
                ancient times the Japanese people have likened the shape of
                lunar craters to a rabbit making{' '}
              ...
              <P>
                ...
                <ForeignPhrase as="i">mochi</ForeignPhrase> is traditionally
                made in Japan:
              </P>
              <Spacer.TextLineToBox />{' '}
              <FigureWithBorder>
