...
const webfont = {
  ...
  stylesheet:
    'https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,600;1,700&family=Cormorant+SC:wght@600;700&family=Cormorant:wght@700&display=swap',
